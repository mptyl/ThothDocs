...
Per vedere come utilizzare ThothAI con la configurazione di default leggere l'apposita [sezione di questa documentazione.](../3-quickstart/3.2-quickstart_frontend.md)
...
A questo punto si può procedere alla [fase successiva](../3-install/1.5-quick_setup.md)
