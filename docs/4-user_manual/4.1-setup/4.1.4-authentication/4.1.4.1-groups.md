...
Nell'autenticazione di Django` un **gruppo** è un modo per categorizzare gli utenti e assegnare loro permessi e attributi in modo collettivo. 

In Thoth, il concetto di **gruppo** è stato esteso per offrire un controllo più granulare sull'esperienza utente nell'esecuzione delle interrogazioni, attraverso un [Profilo di Gruppo](4.1.4.3-group_profiles.md) che è associato a ogni gruppo standard di Django.
