...
- **Copia automaticamente i database di sviluppo** dalla directory `./data/dev_databases` nel volume condiviso
- Questi sono necessari per la comunicazione tra container e per condividere i database tra thoth_be e thoth_ui
...
#### 4.1.5
Una volta terminata l'installazione di backend e frontend, passare alla fase successiva di [quick setup](../1-install/1.5-quick_setup.md)
